...
import com.ms.order_service.model.PurchaseRequest;
...
public class ProductClient {
    ...
    public List<PurchaseResponse> purchaseProducts(List<PurchaseRequest> requests, String authorizationHeader){
